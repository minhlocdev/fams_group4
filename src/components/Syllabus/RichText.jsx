...
export default function RichText({ value, onChange, error }) {
    ...
    icons["undo"] = `<svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" fill="none">
    ...
    icons["redo"] = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
    ...
    icons['color'] = `<svg viewBox ="0 0 18 18" style="background-color:black;border-radius:3px">
    ...
    return (
        <ReactQuill theme="snow" formats={formats} modules={modules} value={value} onChange={handleOnChange} placeholder="Content goes here..."
