            ...
            <Grid container spacing={4}>
                        ...
                        <CardContent>
                            <Stack>
                                <Grid container spacing={2}>
                                    <Grid item xs={5} >
                                        <Stack direction='row' sx={{ alignItems: 'center', fontSize: 14, mt: 2 }}>
                                            <StarBorderIcon />
                                            Level
                                        </Stack>
                                        <Stack direction='row' sx={{ alignItems: 'center', fontSize: 14, mt: 2 }}>
                ...
                <Grid item xs={7.5}>
                    <Card variant="outlined">
                        <CardContent>
                            <Stack>
                                <Stack direction='row' spacing={2} sx={{ alignItems: 'center', fontSize: 14, mt: 2 }}>
